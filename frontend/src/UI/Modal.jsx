...
const Modal = ({
    ...
    return <div className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-white">
        ...
        <div className={'relative flex flex-col bg-gray-950 shadow-lg rounded-xl overflow-hidden'}>
            ...
            <button className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-xl text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5"
            type="Button"
            onClick={onClose}>
                <svg
                    className="w-3 h-3"
